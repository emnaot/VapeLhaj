...
const CategroyWiseProductDisplay = ({ category, heading }) => {
  ...
  return (
    <div className="container mx-auto max-w-[1350px] px-0 my-6 relative" style={{ margin: "0 auto" }}>
        ...
        {loading ? (
          ...
          data.map((product, index) => (
            <Link
              ...
              onClick={scrollTop}
            >
              <div className="bg-gray-100 h-64 p-4 flex justify-center items-center relative rounded-2xl group">
              ...
              <div className="p-0 grid gap-0 flex-grow">
                ...
                <div className="flex justify-center items-center my-1">
                  {[...Array(5)].map((_, starIndex) => (
                    <span key={starIndex} className="text-red-500 text-xl">
                      ★
                    </span>
                  ))}
